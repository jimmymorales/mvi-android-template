        ...
        publications {
            create<MavenPublication>("release") {
                ...
                pom {
                    ...
                    url.set("https://github.com/jimmymorales/mviandroidtemplate/")
                    ...
                    developers {
                        developer {
                            id.set("jimmymorales")
                            name.set("jimmymorales")
                        }
                    }
                    scm {
                        connection.set("scm:git:git://github.com/jimmymorales/mviandroidtemplate.git")
                        developerConnection.set("scm:git:ssh://github.com/jimmymorales/mviandroidtemplate.git")
                        url.set("https://github.com/jimmymorales/mviandroidtemplate/")
                    }
                    issueManagement {
                        system.set("GitHub Issues")
                        url.set("https://github.com/jimmymorales/mviandroidtemplate/issues")
                    }
                }
            }
        }
